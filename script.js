const translations = {
  lv: {
    ...
    'about-title': 'Tava sapņu māja "Jūrasmalā"',
    ...
    'table-area': 'Zemes platība, m²',
    'table-price': 'Cena, EUR',
    'table-availability': 'Zemes gabala pieejamība',
    'table-land': 'Zeme',
  ...
  en: {
    ...
    'about-title': 'Your Dream Home in "Jūrasmala"',
    ...
    'table-offer': 'Offer',
    'table-area': 'Land Area, m²',
    'table-price': 'Price, EUR',
    'table-availability': 'Plot Availability',
    'table-land': 'Land',
  ...
  ru: {
    ...
    'about-title': 'Дом вашей мечты в "Юрасмала"',
    ...
    'table-area': 'Площадь земли, м²',
    'table-price': 'Цена, EUR',
    'table-availability': 'Доступность участка',
    'table-land': 'Земля',
...
function createOverlayDropdown() {
  ...
  if (isMobile) {
    ...
    dropdownMenu.style.cssText = `
      ...
      box-shadow: 0 12px 48px rgba(0, 0, 0, 0.5);
      min-width: 140px;
      margin-top: ${buttonRect.bottom + 8}px;
      margin-right: ${window.innerWidth - buttonRect.right}px;
      cursor: default;
      opacity: 0;
  ...
  languages.forEach((lang, index) => {
    ...
    option.style.cssText = `
      ...
      ${index === 0 ? 'border-top-left-radius: 6px; border-top-right-radius: 6px;' : ''}
    ...
    option.innerHTML = `
      <span style="font-weight: 600; pointer-events: none;">${lang.code.toUpperCase()}</span>
...
function loadMap() {
  ...
  if (mapPlaceholder && cookiesAccepted) {
