...
const translations = {
  lv: {
    ...
    'table-land': 'Zeme',
    'table-land-house': 'Zeme un māja (82m²)',
    'table-land-house-60': 'Zeme un māja (60m²)',
  ...
  en: {
    ...
    'table-land': 'Land',
    'table-land-house': 'Land and house (82m²)',
    'table-land-house-60': 'Land and house (60m²)',
  ...
  ru: {
    ...
    'filter-reserved': 'Забронированные',
    'table-address': 'Адрес',
    ...
    'table-land': 'Земля',
    'table-land-house': 'Земля и дом (82м²)',
    'table-land-house-60': 'Земля и дом (60м²)',
...
function initPageLoad() {
  ...
  const img = new Image();
  img.src = 'data/coastal_image.webp';
  img.onload = () => {
